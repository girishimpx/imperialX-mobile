        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style:GoogleFonts.plusJakartaSans(color: widget.centerSelected
                  ? widget.activeColor
                  : widget.inActiveColor, fontSize: 12.0)
          ...
          child: InkWell(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  item.text!,
                    style:GoogleFonts.plusJakartaSans(color: color, fontSize: 12.0)
                )
              ],
            ),
          ),
